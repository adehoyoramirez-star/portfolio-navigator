...
export const STRESS_SCENARIOS: StressScenario[] = [
  {
    ...
    proxyReturns: {
      ...
      "QUAL":     -0.40, // quality stocks cayeron menos que el mercado (defensivos)
      ...
      "QQQ":      -0.45, // Nasdaq 100 cayó menos que SPX (tech no fue epicentro)
  ...
  },
  {
    ...
    proxyReturns: {
      ...
      "QUAL":     -0.25, // quality resistió mejor que growth en el crash tech
      ...
      "QQQ":      -0.80, // Nasdaq 100 = epicentro del crash dot-com
  ...
  },
  {
    ...
    proxyReturns: {
      ...
      "QUAL":     -0.18, // quality stocks cayeron menos que el S&P 500 en COVID
      ...
      "QQQ":      -0.28, // Nasdaq 100 cayó pero se recuperó en V
  ...
  },
  {
    ...
    proxyReturns: {
      ...
      "QUAL":     -0.15, // quality resistió mejor que growth en subida de tipos
      ...
      "QQQ":      -0.33, // Nasdaq 100 sufrió con subida de tipos
  ...
  },
  {
    ...
    proxyReturns: {
      ...
      "QUAL":     +0.05, // quality subió en 2018 (flight to quality)
      ...
      "QQQ":      +0.05, // Nasdaq 100 subió ligeramente (tech fuerte en 2018)
