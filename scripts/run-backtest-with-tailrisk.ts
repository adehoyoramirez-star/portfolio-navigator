// run-backtest-with-tailrisk.ts (versión ES module, compatible con "type": "module")

import fs from 'fs';
import path from 'path';
import { fileURLToPath } from 'url';
import { runBacktest } from './src/core/backtest/backtestEngine.js';
import { ASSETS } from './src/lib/constants.js';
...
// 6. Ejecutar backtest
console.log('Ejecutando backtest con tail risk overlay...');
...
const outputPath = path.join(__dirname, 'backtest_result_tailrisk.csv');
